        ...
        if outfile:  # outfile was given as parameter
            ...
            if do_verify:
                ...
                tee = subprocess.Popen(
                    ["tee", current_outfile], stdin=subprocess.PIPE)
            ...
            if current_outfile:
                ...
                if do_verify:
                    try:
                        ...
                        print(e)
                        verify_failed_files += 1
                        os.rename(current_outfile,
                                  current_outfile + "_unverified")
...
def status_msg(
    ...
    if do_verify:
        mess += ", %i %sverification failed" % (
            verify_failed_files, verification_type)
    return mess
